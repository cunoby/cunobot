  ...
  function Tabs:CreateTab(Config)
    ...
    function Sections:AddSection(Title, OpenSection)
      ...
      function Item:AddTable(Config)
        ...
        local ContainerLayout = Custom:Create("UIListLayout", {
          Padding = UDim.new(0, 3),
          SortOrder = Enum.SortOrder.LayoutOrder
        }, TableContainer)

        local function CreateRow(Data, IsHeader)
          local Row = Custom:Create("Frame", {
            BackgroundColor3 = IsHeader and Custom.ColorRGB or Color3.fromRGB(255, 255, 255),
            BackgroundTransparency = IsHeader and 0.5 or 0.96,
            BorderSizePixel = 0,
            Size = UDim2.new(1, 0, 0, 25),
            Name = IsHeader and "Header" or "Row"
          }, TableContainer)
          ...
          for colIndex, textData in ipairs(Data) do
            ...
            local Cell = Custom:Create(CellType, {
              ...
              TextColor3 = Color3.fromRGB(255, 255, 255),
              TextSize = 12,
              TextTransparency = IsHeader and 0 or 0.3,
          ...
          if HasButton then
            if IsHeader then
              ...
              local BuyBtn = Custom:Create("TextButton", {
                Font = Enum.Font.GothamBold,
                Text = ButtonText,
                TextColor3 = Color3.fromRGB(255, 255, 255),
                TextSize = 11,
        ...
        Funcs_Table:Refresh(Rows)

        ContainerLayout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
          local TotalY = ContainerLayout.AbsoluteContentSize.Y
          TableContainer.Size = UDim2.new(1, -20, 0, TotalY)
          TableFrame.Size = UDim2.new(1, 0, 0, TotalY + 40)
          UpdateSizeSection()
        end)
